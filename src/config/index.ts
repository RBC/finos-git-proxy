...
export const getTLSKeyPemPath = () => {
  if (_userSettings && _userSettings.tlsKeyPemPath) {
    ...
    _tlsKeyPemPath = _userSettings.tlsKeyPemPath;
  }
  if (!_tlsKeyPemPath) {
...
export const getTLSCertPemPath = () => {
  if (_userSettings && _userSettings.tlsCertPemPath) {
    ...
    _tlsCertPemPath = _userSettings.tlsCertPemPath;
  }
  if (!_tlsCertPemPath) {
...
export const getTLSEnabled = () => {
  if (_userSettings && _userSettings.tlsEnabled) {
    _tlsEnabled = _userSettings.tlsEnabled;
  }
  if (!_tlsEnabled) {
    return false;
  }
