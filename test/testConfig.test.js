...
describe('default configuration', function () {
  it('should use default values if no user-settings.json file exists', function () {
    ...
    expect(config.getSSLKeyPath()).to.be.eql(defaultSettings.tls.key);
    expect(config.getSSLCertPath()).to.be.eql(defaultSettings.tls.cert);
  });
  after(function () {
...
describe('user configuration', function () {
  ...
  it('should override default settings for SSL certificate', function () {
    ...
    expect(config.getSSLKeyPath()).to.be.eql(user.tls.key);
    expect(config.getSSLCertPath()).to.be.eql(user.tls.cert);
  });
